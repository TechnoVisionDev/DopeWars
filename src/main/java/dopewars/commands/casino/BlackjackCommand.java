...
public class BlackjackCommand extends Command {
    ...
    public BlackjackCommand(DopeWars bot) {
        super(bot);
        this.name = "blackjack";
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        if (games.containsKey(userID)) {
            String text = FAIL + " You are already playing a blackjack game!";
     ...
     */
    public static MessageEmbed hit(DopeWars bot, User user, long bet, String uuid) {
        // Update game stats
     ...
     * @return a MessageEmbed with the updated game status.
     */
    public static MessageEmbed stand(DopeWars bot, User user, long bet, String uuid) {
        // Get player stats
        Blackjack game = games.get(user.getId());
        int score = calculateValue(game.playerHand());
